...
const Home = () => {
    ...
    useEffect(() => {
        getData(user, setBreaks, setClaims, setSettings, setLoadingData)
    }, [])
    useEffect(() => {
        console.log(claims)
    }, [claims])
                    ...
                    {mode === Mode.Admin ? (
                        ...
                        <>
                            <div className="text-lg">
                                The cookie break is the school's longest running
                                social event: every week a different host buys
                                some biscuits up to the amount of £15 and shares
                                them with everyone else. Thanks to the gracious
                                funding of Research Committee, they get
